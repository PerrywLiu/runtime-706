...
#define t(x,y) SEL_##y = sel_registerNameNoLock(#x, NO)
    ...
    //# 表示将对应变量字符串化
    //## 表示将宏参数名与宏定义代码序列中的标识符连接在一起，形成一个新的标识符
    //栗子：s(load) SEL_load = sel_registerNameNoLock("load",NO)
    //t(resolveInstanceMethod:,resolveInstanceMethod) = SEL_resloveInstanceMethod = sel_registerNameNoLock("resolveInstanceMethod:",NO)
